...
darin enthaltenen Kleinbuchstaben zu Großbuchstaben, und alle Großbuchstaben zu Kleinbuchstaben machen.} \onslide<3->{Sie finden die Datei auf unserer Moodle Seite \info{auf Papier genügt es, nur den bei \T{// TODO} benötigten Code zu schreiben}.}
\begin{plainjava}
