...
!*\onslide<3->*!public class Referenzvariablen {
!*\onslide<3->*!  public static void setzeElementVielleicht(int[] array, int idx, int ele) {
!*\onslide<3->*!    if (array == null || idx >= array.length || ele <= 0) {
!*\onslide<3->*!      System.out.println("Eingabe ungültig!");
!*\onslide<3->*!      return;
!*\onslide<3->*!    }
!*\onslide<3->*!    array[idx] = ele;
!*\onslide<3->*!    ele = 4;
!*\onslide<3->*!    array = null;
!*\onslide<3->*!  }
!*\onslide<3->*!
!*\onslide<3->*!  public static void main(String[] args) {
!*\onslide<3->*!    int ele = 1;
!*\onslide<3->*!    int idx = ele;
!*\onslide<3->*!    ele = 2;
!*\onslide<3->*!    int[] array = new int[3];
!*\onslide<3->*!    setzeElementVielleicht(array, idx, ele);
!*\onslide<3->*!    System.out.println(ele);
!*\onslide<3->*!    System.out.println(idx);
!*\onslide<3->*!    if (array != null) {
!*\onslide<3->*!      for (int wert : array) {
!*\onslide<3->*!        System.out.println(wert);
!*\onslide<3->*!      }
!*\onslide<3->*!    } else {
!*\onslide<3->*!      System.out.println("Array ungültig!");
!*\onslide<3->*!    }
!*\onslide<3->*!  }
!*\onslide<3->*!}!*\onslide<1->*!
\end{plainjava}
...
!*\onslide<9->*!        if (norm == -1.0):ws::ws::ws::ws::ws:return -1.0; !*\onslide<10->*!// Fehler in Unteralgorithmus?
...
\begin{plainjava}
!*\onslide<7->*!public static double berechneF(double x) {
!*\onslide<8->*!    return Math.exp(-(x*x));
!*\onslide<7->*!}
\end{plainjava}
        \item<9-> Natürlich kann man hier auch \bjava{Math.pow(x, 2.0)} oder so benutzen
    \end{itemize}
\end{frame}
