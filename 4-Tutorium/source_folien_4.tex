...
\begin{frame}[fragile]{Ein Array Anlegen}
\SetupLstHl
\begin{itemize}[<+(1)->]
...
!*\onslide<11->*!double[][] m3 = new double[3][]; !*\Snode{@3}*!
!*\onslide<13->*!double[][] m4 = new double[1][2]; !*\Snode{@4}*!
...
\begin{frame}{Jeay}
    \textattachfile{\curpath Matrix.java}{Matrix.java}
\end{frame}
