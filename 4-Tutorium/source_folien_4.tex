...
\begin{frame}[fragile]{a)~Daten Einlesen und b)~\T{\bfseries berechneF}}
    \begin{itemize}[<+(1)->]
...
\begin{frame}
    \textattachfile{\curpath NumerischeIntegration.java}{NumerischeIntegration.java}
\end{frame}
...
\outro{\vskip6mm\centering \onslide<2->{\begin{tikzpicture}
    \pingu[cloak=pingu@bronze!80!pingu@black,left wing grab, lightsaber left=pingu@blue,eyes wink]
\end{tikzpicture}}}
