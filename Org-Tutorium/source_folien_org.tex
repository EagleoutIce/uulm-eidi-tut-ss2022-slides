...
\begin{itemize}[<+(1)->]
    ...
    \item Abgabe in Zweiergruppen (Montags, 11:59\;Uhr) \only<handout:0|5>{\smash{\raisebox{-2pt}{\resizebox*!{\baselineskip}{\usebox\pinguA\!\usebox\pinguB}}}}\only<6->{\smash{\raisebox{-2pt}{\resizebox*!{\baselineskip}{\usebox\pinguA\hskip8em\usebox\pinguB}}}}\vfill
