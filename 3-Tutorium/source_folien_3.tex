...
\end{plainjava}
            \item Damit assertions ausgeführt werden, benötigt java \bbash{-ea} als Argument: \bbash{java -ea Example}\infoblock{Das steht hier für \say{enable assertions}}
            \item Assertions sollten immer nur zusätzlich zu Bedingungen verwendet werden.
        \end{itemize}
        \item Für \say{richtige} Tests gibt es Pakete wie JUnit [TODO: link]
        \item Allgemein ist Testen ein aufwändiger und wichtiger Teil der Programmierarbeit! TODO: eventuelle Vertieung anschneiden.
    \end{itemize}
\end{frame}
}
\fi
