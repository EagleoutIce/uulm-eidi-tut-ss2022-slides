...
\begin{itemize}
    \itemsep5pt
    \item Arrays sind in Java \emph{komplexe} Datentypen \info{vs. den primitiven Datentypen}
    ...
    \item Neben einem \say{gültigen} Wert, können diese auch den Wert \bjava{null} haben. \begin{itemize}
        \item Mit \bjava{double[][] matrix = null;} liefert z.B. \bjava{matrix[1]} eine \bjava{NullPointerException}
...
\begin{frame}
    TODO: MEthoden
    TODO: komplexe Datentypen (prüfen auf null)
