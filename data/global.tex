...
\tabular{>{\raggedleft\arraybackslash}p{2cm}@{\hskip1.33em}*4{c@{}}}
    ...
    %
    & \MayLoadActive{1}{2} & & & \MayLoadActive{8}{12}\medskip\\
    ...
    &\MayLoadActive{5}{7\,\&\,11}&\MayLoadActive{7}{8}&\MayLoadActive{9}{9}&\MayLoadActive{6}{10}
\endtabular
}\par
...
\def\CodeFileMarker#1{{\color{lightgray}\sffamily\tiny\llap{\faFileCodeO~\thinspace}#1}}
\newcommand\ShowInTheWeb[2][.25mm]{\smash{\raisebox{#1}{\color{lightgray}\sffamily\tiny\fancyulcolor{lightgray}\link{#2}{display in browser}}}\vspace*{-#1}}
...
\newcommand<>\FileMarkerAttach[2][]{\only#3{\attachfilesetup{color=black}\textattachfile{\curpath #1#2}{\rawlink{#2}}}}
