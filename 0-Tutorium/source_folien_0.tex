...
\newcounter{presencesub}\def\t#1{\stepcounter{presencesub}\alph{presencesub})~\textit{#1}}
...
\smallskip\par
    \only<9->{\setcounter{presencesub}0\relax Führen Sie die Schritte der Algorithmenentwicklung durch:
    \onslide<10->{\t{Problemspezifikation}}\onslide<11->{, \t{Problemabstraktion}}\onslide<12->{, \t{Algorithmenentwurf}}\onslide<13->{, \t{Korrektheitsnachweis bzw. Verifikation}}\onslide<14->{ und die \t{Aufwandsanalyse}.}}
    \onslide<1->
\end{aufgabe}
\end{frame}
}
