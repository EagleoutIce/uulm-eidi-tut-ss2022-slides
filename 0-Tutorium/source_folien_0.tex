...
\enditemize
\endminipage};}\kern-2.5mm}\par\only<-3|handout:0>{\parshape 1
...
\begin{enumerate}[<+(3)->]
    ...
    \begin{description}[Partiell Korrekt:]
        \itemsep8pt
        \item[Termination:] \(Z1\) und \(Z3\)--\(Z6\) sind Elementaroperationen.\\ Diese Terminieren per Definition.\medskip\par
