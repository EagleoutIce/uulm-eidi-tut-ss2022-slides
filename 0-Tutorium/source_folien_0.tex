...
\StartCode
    \onslide<+(1)->{$i  = 0$\;}
    \onslide<+(1)->{$\a = Falsch$\;}
    \onslide<+(1)->{$\b = Falsch$\medskip\;}
    \onslide<+(1)->{\While{$i \leq N$}{
        \onslide<+(1)->{\lIf{\boxme{shadeA}{\(S[i]\)~\T{==}~\('a'\)} \KwAnd\ \boxme{shadeA}{\(\b\)~\T{==}~\(Falsch\)}}{$\a= Wahr$}}
        \onslide<+(1)->{\lIf{{\boxme{shadeA}{\(S[i]\)~\T{==}~\('b'\)}}}{\boxme{shadeA}{$\b= Wahr$;} \boxme{shadeA}{$\a = Falsch$;} Breche Solange ab}}
        \onslide<+(1)->{Erhöhe~\(i\) um \(1\)\;}
    }}\medskip
    \onslide<+(1)->{\lIf{\(\a\)~\T{==}~\(Wahr\)}{Gebe aus: \say{Ja}}}
