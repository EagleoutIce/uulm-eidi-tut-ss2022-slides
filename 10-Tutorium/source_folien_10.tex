...
\begin{itemize}[<+(1)->]
    \item Adjazenzmatrix und Liste (Kompakt Kram oder so letztes sem)
    \item 3: Traversierungen angeben
\end{itemize}
\end{frame}
