...
\lstfs{9}\def\hlopa{.4}
\begin{tikzpicture}[@O]
    \def\hlcolor{orange!90!pingu@black}
    \onslide<12->{
...
\begin{tikzpicture}[@O]
    ...
    \onslide<6->{
        \fill[rounded corners=1.6pt,orange!90!pingu@black,opacity=\hlopa] ([xshift=1mm,yshift=-5pt]@CLASS) rectangle ([xshift=1mm-3.2pt,yshift=5pt]@CLASS@);
