...
!*\onslide<13->*!System.out.println(!*\tikzmarknode{@6}{\sbasic{arr[arr.length - \snum{\HStrut1}]}}*!); !*\onslide<14->*!// :yields: 13
\end{plainjava}
    \end{itemize}
...
\begin{plainjava}
|ihl|public static void main(|ihl|String[] args|ihl|) {|ihl|
