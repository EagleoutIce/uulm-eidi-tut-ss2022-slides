...
\iffull
\setbox\pinguA=\hbox{\tikz\pingu[cloak,lightsaber right=pingu@green,lightsaber right length=1.35cm,shirt=pingu@bronze!70!pingu@black,small,eyes wink,cane left];} % TODO: ,cane left length=3mm
