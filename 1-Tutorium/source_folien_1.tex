...
\end{frame}
% 14. 4
\def\hlcode#1#2{\fill[paletteA,opacity=.2,rounded corners=1pt] ([shift={(-.5mm,1.9pt)}]#1.south west) rectangle ([shift={(.5mm,-1.9pt)}]#1.north east); \coordinate (#2) at (#1.east);}
...
\null\hfill\smash{\raisebox{-.5cm}{\scalebox{0.8}{\onslide<9->{\begin{tikzpicture}% [overlay,remember picture]
