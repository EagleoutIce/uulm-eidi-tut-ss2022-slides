...
/*\onslide<3->*/}
\end{minted}
\onslide<4->{Implementieren Sie die Klasse \T{EquilateralTriangle}, welche ein gleichseitiges Dreieck repräsentieren soll. Die abgeleitete Klasse soll von \T{RegularPolygon} erben und zusätzlich einen Konstruktor anbieten, welcher die Seitenlänge als Parameter übernimmt. Die
