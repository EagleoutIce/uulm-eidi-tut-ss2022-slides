...
/*\onslide<4->*/      int bi = binary.charAt(i - 1) == '1' ? 1 : 0;
/*\onslide<4->*/      d += bi * Math.pow(2, n - i);
/*\onslide<4->*/   }
/*\onslide<4->*/   return d;
/*\onslide<3->*/}
\end{minted}
In wie weit unterscheidet sich ihre Berechnung von der aus \SidebarTask{Eine Aufwandsanalyse}.
   \onslide<1->{\ShortSide}%
\end{frame}
\SidebarReset

\iffull
\outro{\rlap{Basiert auf der \def\fancyulbackground{btdm@primary}\fancyulcolor{pingu@white}\link{https://github.com/EagleoutIce/christmas-eidi-recap}{Weihnachtswiederholung}}}
\else
