...
\UsePalette{Recap}
\fancyulcolor{paletteA!50!white}
...
\updateitemize{1.}\begin{enumerate}[<+(1)->]
   \setcounter{enumi}{3}
   \item Implementieren Sie Ihren Algorithms aus \TaskRef{Ein Algorithmenentwurf} als die statische Funktion \bjava{long binZuDez(String binary)}:\medskip
   \begin{algorithm}[H]
\PreCode
...
\SidebarSolution
\begin{frame}[fragile,c]{Mein kleiner Algorithmus}
\only<2-|handout:1> {4.~Algorithmus implementieren}
\medskip
\SetupLstHl
\begin{onlyenv}<3-|handout:0>
\begin{minted}[escapeinside={/*}{*/}]{java}
/*\onslide<2->*/|ihl|public class BinaerUmwandler {|ihl|
/*\onslide<2->*/   |ihl|private String binary;|ihl|
/*\onslide<2->*/   |ihl|private long decimal;|ihl|
/*\onslide<2->*/   |ihl|...|ihl|
public static long binZuDez(String binary) {
   int n = binary.length();
   long d = 0;
   for(int i = 0; i < N; i++) {
      d += binary.charAt(i) * Math.pow(2, N-i);
   }
}
/*\onslide<2->*/|ihl|}|ihl|
\end{minted}
