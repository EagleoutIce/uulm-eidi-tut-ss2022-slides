...
\ShowFull<9> (umain3.north) to[out=100,in=-30] (main.east);
% [xshift=-2pt]
\ShowFull<10> (ua4.north) to[out=100,in=-30] ([xshift=-2pt]a.east);
\ShowFull<10> (umain4.north) to[out=100,in=-30] (main.east);
\end{tikzpicture}%
\end{frame}
...
/*\onslide<3->*/}
\end{minted}
In wie weit unterscheidet sich ihre Berechnung von der aus \TaskRef{Eine Aufwandsanalyse}.
   \onslide<1->{\ShortSide}%
\end{frame}
\SidebarReset
