...
\end{align*}
\onslide<11->{\scriptsize Das heißt, für konkrete Implementationen können durch Anpassungen und Unteralgorithmen unterschiedliche Laufzeitkomplexitäten berechnet werden.}
\end{frame}
\SidebarReset
}
