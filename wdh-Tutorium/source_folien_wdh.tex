...
\newsavebox\pingunote
\savebox\pingunote{\tikz\pingu[left wing wave,santa hat,cloak=paletteA!80!pingu@white,cloak cap=!hide,eyes wink,santa beard];}
...
\end{layout-imageonly}
\item<8-> [TODO: Update this]Die Klasse \bjava{Tiger} sei im selben, \bjava{Auto} sei in einem anderen Paket, \bjava{Felspingu} erbe von \bjava{Pinguin} aber sei in einem anderem Paket: \medskip\par
...
\onslide<2->{\footnotesize\flushleft Im Code [TODO: update this and update enumerate and make small sheet with code]finden sich \textsb{10 Fehler}, welche vom Java-Compiler erkannt werden.
...
\begin{frame}
   ...
   TODO: doch das mit den Begriffen i guess
\end{frame}
