...
\end{onlyenv}
\begin{itemize}
   \item<14-> Die Klassen finden sich dann hier: \only<14->{\textattachfile{\curpath BinaerUmwandler.java}{BinaerUmwandler.java}} und \only<14->{\textattachfile{\curpath BinaerHaupt.java}{BinaerHaupt.java}}.
\end{itemize}
\end{frame}
\SidebarReset
