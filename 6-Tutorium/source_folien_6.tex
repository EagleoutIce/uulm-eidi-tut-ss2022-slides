...
!*\onslide<2->*!    !*\MD5*!return isPalindrom!*\mb{7}\mbg[2-3]{8-42}*!eRecursive(s!*\mb6*!.toLowerCase());!*\ml[4]{43}*! !*\rBS<handout:2-3|6-41>{\dq regalelager\dq }~~\rBS<handout:4|43>{true}*!
!*\onslide<2->*!}
...
\outro{\vskip9mm\centering \onslide<2->{\scalebox{1.5}{\begin{tikzpicture}
    % ghost weil sichtbarkeit :eyes:
    \pingu[wings grab,cup=pingu@purple,eyes angry,hair 3=pingu@purple,body type=chubby,:ghost]
