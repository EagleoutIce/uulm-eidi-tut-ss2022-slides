...
\AnimateCode[@2]{onslide={%
    ...
    *\Line{4}\Location{Person-ctor}\Comment{Person(String,int,int)},
    o4:{},-,-,-,-,-,-,-,-,-,4,+,
    *\Line{5}\Location{getName}\Comment{getName()},
    o5:{},-,5,+,
    *\Line{6}\Location{getValuePair}\Comment{getValuePair()},
    o6:{},-,6,+,7,+,+,
    *\Line{9}\Location{getName}\Comment{getName()},
    o9:{},-,9,+,10,+,11,+,
    *\Line{12}\Location{getValuePair}\Comment{getValuePair()},
    o12:{},-,12,+,13,0
},first slide=5}
\begin{minted}[escapeinside={/*}{*/}]{java}
...
\begin{tikzpicture}[@O]% THATS NO PENGU :C The federation of penguin support would never lie!
    ...
    \onslide<32->{\node[above=\btdmfootheight+.75cm,draw,rounded corners=2pt,gray,minimum width=3cm,align=left,minimum height=2.125\baselineskip] at(current page.south) {\T{Heinz 11 22}\\\only<49->{\T{Heinz 33 44}}};}
\end{tikzpicture}}
\end{frame}
}
