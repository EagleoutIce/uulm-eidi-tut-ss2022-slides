...
\begin{frame}[fragile,c]{Aufgabe 3: Seiteneffekte}
\lstfs{8}\columns[t,onlytextwidth]
\column{.525\linewidth}
\begin{plainjava}[lineskip=0.25pt]
!*\CodeFileMarker{Person.java}*!
class Person {
    private String name;
    private ValuePair v;
...
\endcolumns
\begin{tikzpicture}[@O]
    \node[below left,text width=7cm] at(current page.north east) {\begin{plainjava}
!*\CodeFileMarker{ValuePair.java}*!
class ValuePair {
    int x; int y;
